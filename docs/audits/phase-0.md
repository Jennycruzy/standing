...
| ACP sandbox lifecycle completed | Fail | Requires two registered Virtuals agents, their smart wallets/entity IDs, a whitelisted developer key, and funded buyer USDC. None was supplied; no account or payment was created. |
